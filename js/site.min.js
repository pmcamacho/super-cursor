...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superCursorAnimation = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateUnderneathClasses(x, y) {
	  ...
	  for (var _i = 0; parent !== null && parent !== undefined; _i++) {
	    var _targetClasses = parent.className;
	    if (_targetClasses !== undefined) {
	      _targetClasses = _targetClasses.split(' ');
	      classes['parent' + _i] = [];
	      for (var j = 0; j < _targetClasses.length; j++) {
	        classes['parent' + _i].push(_targetClasses[j]);
	      }
	    }
